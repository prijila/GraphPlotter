...
public interface LabeledExprListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterEvaluate(LabeledExprParser.EvaluateContext ctx);
	/**
	 * Exit a parse tree produced by the {@code evaluate}
	 * labeled alternative in {@link LabeledExprParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitEvaluate(LabeledExprParser.EvaluateContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterDouble(LabeledExprParser.DoubleContext ctx);
	/**
	 * Exit a parse tree produced by the {@code double}
	 * labeled alternative in {@link LabeledExprParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitDouble(LabeledExprParser.DoubleContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code MulDivPow}
	 * labeled alternative in {@link LabeledExprParser#expr}.
	 * @param ctx the parse tree
	 */
	void enterMulDivPow(LabeledExprParser.MulDivPowContext ctx);
	/**
	 * Exit a parse tree produced by the {@code MulDivPow}
	 * labeled alternative in {@link LabeledExprParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitMulDivPow(LabeledExprParser.MulDivPowContext ctx);
	/**
